...
export default memo(function Card({ game, type }) {
  ...
  return (
    <>
      <NavLink to={`/videogame/${id}`} className={`rounded-lg bg-neutral-base-300 p-1 transition-base hover:bg-gradient-to-t hover:from-accent-soft/50 hover:to-neutral-base-300 ${type === "favorites" ? "w-full" : "col-span-2"}`}>
